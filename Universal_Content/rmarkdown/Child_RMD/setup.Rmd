...
```{r setup, echo=FALSE, include=FALSE}
  ...
  knitr::opts_chunk$set(
    cache.path = file.path(params$base.directory, "_cache", "Impact_Report"),
    echo = FALSE,
    warning = params$show.warnings,
    message = params$show.warnings,
    fig.topcaption = TRUE,
  ...
  options(fig_num_str = NULL) # Remove Appendix Letter if it exists
