...
```{r, cache=FALSE, results="asis", echo=FALSE}
	...
	for (ca in names(grd.subj.list)) {
		...
		chrt.plots <-  unique(gsub(".png|.pdf", "", list.files(file.path("Goodness_of_Fit", paste0(ca, ".", chrt.year, ".", "BASELINE", gof.type)))))
		...
		chrt.plot.list <- c(chrt.plot.list, file.path("Goodness_of_Fit", paste0(ca, ".", chrt.year, ".", "BASELINE", gof.type), paste0(chrt.plots[!is.na(chrt.plots)], ".png")))
		...
		bsln.plots <- unique(gsub(".png|.pdf", "", list.files(file.path("Goodness_of_Fit", paste0(ca, ".", bsln.year, ".", "BASELINE", gof.type)))))
		...
		bsln.plot.list <- c(bsln.plot.list, file.path("Goodness_of_Fit", paste0(ca, ".", bsln.year, ".", "BASELINE", gof.type), paste0(bsln.plots[!is.na(bsln.plots)], ".png")))
