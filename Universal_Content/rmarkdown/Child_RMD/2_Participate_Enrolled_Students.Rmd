...
```{r, part-enroll1, overall-participation-table, fig.cap=ovrall.part.cap, out.width="0", out.height="0", out.extra=tab.out.ex, class = "figtab", results="asis"}
