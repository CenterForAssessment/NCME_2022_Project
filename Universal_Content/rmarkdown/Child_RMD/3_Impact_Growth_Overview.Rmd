...
```{r, msgp-imputed, fig.cap="Observed versus estimated 2021 median (mean) baseline SGPs by content area and grade", out.width="0", out.height="0", out.extra=tab.out.ex, class = "figtab", results="asis", eval = params$imputations}
