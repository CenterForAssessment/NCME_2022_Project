...
abstract: |-
  ...
  ```
appendix: |-
  ```{r, appndx-A, echo=FALSE, results='asis'}
    cat(readLines("Appendix_A_Init_Analyses.html"), sep = '\n')
  ```
  ...
  ```
appendix-prefix: ["A", "R"] # Need to correspond to the `appendix-prefix` YAML in the appendix script(s)
